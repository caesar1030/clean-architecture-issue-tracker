...
export interface EditIssueContentsTextAreaProps
  extends ComponentPropsWithRef<'textarea'> {
  issue: IssueResponse['data'] | undefined;
}

const EditIssueContentsTextArea = forwardRef(
  (
    { issue, ...rest }: EditIssueContentsTextAreaProps,
...
export default EditIssueContentsTextArea;
