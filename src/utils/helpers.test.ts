...
describe('getTimeDiff()', () => {
  ...
  it('1분 이상 1시간 미만 차이일 경우 "n분"을 반환해야 한다.', () => {
    const now = new Date(Date.now());
  ...
  it('1시간 이상 1일 미만 차이일 경우 "n시간"을 반환해야 한다.', () => {
    const now = new Date(Date.now());
  ...
  it('1일 이상 1개월 미만 차이일 경우 "n일"을 반환해야 한다.', () => {
    const now = new Date(Date.now());
  ...
  it('1개월 이상 1년 미만 차이일 경우 "n개월"을 반환해야 한다.', () => {
    const now = new Date(Date.now());
